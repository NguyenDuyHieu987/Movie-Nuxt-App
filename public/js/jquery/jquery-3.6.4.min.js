...
!(function (e, t) {
  ...
  function Oe(e, t, n) {
    for (var r, i = t ? S.filter(t, e) : e, o = 0; (r = i[o]) != null; o++)
      n || r.nodeType !== 1 || S.cleanData(ye(r)),
        r.parentNode &&
    ...
    S.fn.extend({
      ...
      empty: function () {
        for (var e, t = 0; (e = this[t]) != null; t++)
          e.nodeType === 1 && (S.cleanData(ye(e, !1)), (e.textContent = ''));
        return this;
      },
      clone: function (e, t) {
        return (
  ...
  const Ue = E.createElement('div').style;
  const Xe = {};
  function Ve(e) {
      ...
      _default: {
        ...
        set: function (e) {
          S.fx.step[e.prop]
            ? S.fx.step[e.prop](e)
            : e.elem.nodeType !== 1 ||
                (!S.cssHooks[e.prop] && e.elem.style[Ve(e.prop)] == null)
              ? (e.elem[e.prop] = e.now)
  ...
  S.fn.extend({
    ...
    S.fn.extend({
      ...
      hasClass: function (e) {
        ...
        t = ' ' + e + ' ';
        while ((n = this[r++]))
          if (n.nodeType === 1 && (' ' + yt(vt(n)) + ' ').indexOf(t) > -1)
            return !0;
        return !1;
      }
    });
  ...
  (Wt.href = Tt.href),
    S.extend({
      ...
      ajax: function (e, t) {
        ...
        let i;
        let o;
        const y = S.ajaxSetup({}, t);
        const v = y.context || y;
        const m = y.context && (v.nodeType || v.jquery) ? S(v) : S.event;
        const x = S.Deferred();
        ...
        function l(e, t, n, r) {
          ...
          h ||
            ...
            !i &&
              S.inArray('script', y.dataTypes) > -1 &&
