...
export function getList(type: string = 'all', skip: number = 1, limit: number = 20) {
...
export function removeItemList(params: { id?: string; movie_id: string; media_type: string }) {
  const bodyFormData = new FormData()
