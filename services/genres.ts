...
export function getGenreById(genre_id: number, allGenres?: genre[]): genre | undefined {
  if (allGenres?.length != 0) {
...
export function getGenreByName(genre_name: string, allGenres?: genre[]): genre | undefined {
  if (allGenres?.length != 0) {
