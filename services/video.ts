...
export async function makeVideoRequest(url: string, options: AxiosRequestConfig = {}) {
...
export function getVideo(path: string, startByte: number = 0, endByte: number = 1024 * 1024) {
