...
export function getDaTaSearch(query: string, page: number = 1, limit: number = 20) {
...
export function getDaTaSearchInTopSearch(query: string, page: number = 1, limit: number = 10) {
  return makeRequest(`/search/top-history/search?query=${query}&page=${page}&limit=${limit}`)
}
...
export function getDaTaSearchInHistory(query: string, page: number = 1, limit: number = 10) {
  return makeRequest(`/search/search-history/search?query=${query}&page=${page}&limit=${limit}`)
}

export function addSearch(params: { movie_id?: string; media_type?: string; query: string }) {
